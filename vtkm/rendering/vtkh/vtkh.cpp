...
#else
    throw vtkm::cont::ErrorBadValue("Cannot fetch CUDA device count: VTK-m lacks CUDA support");
#endif
    return device_count;
}
...
#else
    throw vtkm::cont::ErrorBadValue("Cannot set CUDA device: VTK-m lacks CUDA support");
#endif
