...
bool VTKMDataSetInfo::IsStructured(const vtkm::cont::DataSet& data_set, int& topo_dims)
{
  const vtkm::cont::UnknownCellSet cell_set = data_set.GetCellSet();
  return IsStructured(cell_set, topo_dims);
}

bool VTKMDataSetInfo::IsStructured(const vtkm::cont::UnknownCellSet& cell_set, int& topo_dims)
{
...
bool VTKMDataSetInfo::IsRectilinear(const vtkm::cont::DataSet& data_set)
{
  const vtkm::cont::CoordinateSystem coords = data_set.GetCoordinateSystem();
  return IsRectilinear(coords);
}

bool VTKMDataSetInfo::IsRectilinear(const vtkm::cont::CoordinateSystem& coords)
{
...
bool VTKMDataSetInfo::IsUniform(const vtkm::cont::DataSet& data_set)
{
  const vtkm::cont::CoordinateSystem coords = data_set.GetCoordinateSystem();
  return IsUniform(coords);
}

bool VTKMDataSetInfo::IsUniform(const vtkm::cont::CoordinateSystem& coords)
{
...
bool VTKMDataSetInfo::GetPointDims(const vtkm::cont::DataSet& data_set, int* dims)
{
  const vtkm::cont::UnknownCellSet cell_set = data_set.GetCellSet();
  return GetPointDims(cell_set, dims);
}

bool VTKMDataSetInfo::GetPointDims(const vtkm::cont::UnknownCellSet& cell_set, int* dims)
{
  int topo_dims;
...
bool VTKMDataSetInfo::GetCellDims(const vtkm::cont::DataSet& data_set, int* dims)
{
  const vtkm::cont::UnknownCellSet cell_set = data_set.GetCellSet();
  return GetCellDims(cell_set, dims);
}

bool VTKMDataSetInfo::GetCellDims(const vtkm::cont::UnknownCellSet& cell_set, int* dims)
{
  int topo_dims;
  bool is_structured = IsStructured(cell_set, topo_dims);
  bool success = false;
...
bool VTKMDataSetInfo::IsSingleCellShape(const vtkm::cont::UnknownCellSet& cell_set,
                                        vtkm::UInt8& shape_id)
{
  int dims;
  shape_id = 0;
