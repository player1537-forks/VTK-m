...
template class VTKM_RENDERING_EXPORT vtkh::PartialCompositor<vtkh::AbsorptionPartial<vtkm::Float32>>;
template class VTKM_RENDERING_EXPORT vtkh::PartialCompositor<vtkh::AbsorptionPartial<vtkm::Float64>>;
