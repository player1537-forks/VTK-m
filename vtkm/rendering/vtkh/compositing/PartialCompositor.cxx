...
#include <vtkm/rendering/vtkh/compositing/PartialCompositor.h>
...
#include "vtkh_diy_partial_collect.h"
...
#pragma omp parallel for
  ...
  for (int i = 0; i < total_segments; ++i)
  {
    ...
    //
    output_partials[output_offset + i].EmissionBins = partials[current_index].EmissionBins;
  ...
  std::vector<PartialType>& output_partials)
{
  ...
  //
  redistribute(partials, this->mpiComm, global_min_pixel, global_max_pixel);
