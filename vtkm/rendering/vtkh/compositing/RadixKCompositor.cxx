...
#include <vtkm/rendering/vtkh/compositing/ImageCompositor.h>
#include <vtkm/rendering/vtkh/compositing/PayloadImageCompositor.h>
#include <vtkm/rendering/vtkh/compositing/RadixKCompositor.h>
#include <vtkm/rendering/vtkh/compositing/vtkh_diy_collect.h>
#include <vtkm/rendering/vtkh/compositing/vtkh_diy_utils.h>
                   ...
                   const vtkmdiy::RegularSwapPartners& partners)
{
  ...
  vtkmdiy::DiscreteBounds image_bounds = VTKMBoundsToDIY(image.Bounds);
  ...
  std::vector<vtkmdiy::DiscreteBounds> subset_bounds(group_size, VTKMBoundsToDIY(image.Bounds));
...
{
  vtkmdiy::DiscreteBounds global_bounds = VTKMBoundsToDIY(image.OrigBounds);
  ...
  vtkmdiy::all_to_all(master, assigner, CollectImages<ImageType>(decomposer), magic_k);
...
void RadixKCompositor::CompositeSurface(vtkmdiy::mpi::communicator& diy_comm, Image& image)
{
  CompositeImpl(diy_comm, image);
}

void RadixKCompositor::CompositeSurface(vtkmdiy::mpi::communicator& diy_comm, PayloadImage& image)
{
  CompositeImpl(diy_comm, image);
}
